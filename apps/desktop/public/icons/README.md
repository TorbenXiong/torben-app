...
These bundled marks use official source assets to identify the
managed applications in Torben App:

- Node.js: <https://nodejs.org/static/logos/nodejsHex.svg>
- Python: <https://www.python.org/community/logos/>
- Java / OpenJDK: Duke from <https://cr.openjdk.org/~jeff/Duke/png/>
...
- PostgreSQL: [`PostgreSQL_logo.3colors.svg`](https://wiki.postgresql.org/wiki/Logo) from the
  PostgreSQL community wiki.

Rust's mark is [`logo/rust-logo.svg`](https://github.com/rust-lang/rust-artwork/blob/main/logo/rust-logo.svg)
from the official `rust-lang/rust-artwork` repository. Rust artwork is distributed under CC-BY; the other
marks remain subject to their respective project trademark policies. These
assets identify the managed applications and are not presented as Torben App
branding or as an endorsement by their owners.
